    ...
    <div className='Navigation'>
        ...
        <Route exact path='/'>
          {props.isLoggedIn ? (
            <>
              ...
              <div className='Navagation__nav-box'>
                ...
                <Link className='Navigation__profile-link' to='/profile'>
                  <div className='Navigation__profile-container'>
                    <img
                      className='Navigation__profile-logo1'
                      src={accountlogo}
                      alt='Логотип-Профиля'
                    />
                    <img
                      className='Navigation__profile-logo2'
                      src={accountlogo2}
                      alt='Логотип-Профиля'
                    />
              ...
              >
                <img src={navbutton} alt='nav_image'></img>
              </button>
            </>
          ) : (
            <>
      ...
      <div className={DropMenuClass}>
        <div className='Navigation__dropdown-content'>
          ...
          >
            <img src={closelogo} alt='close_logo'></img>
          </button>
          <Link
            onClick={handleDropMenuToggle}
            to='/profile'
            className='Navigation__profile-container Navigation__profile-container_place_dropdown'
          >
            <img
              className='Navigation__profile-logo1'
              src={accountlogo}
